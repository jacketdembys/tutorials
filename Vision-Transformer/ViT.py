...
class PatchEmbed(nn.Module):
    ...
    def __init__(self, img_size, patch_size, in_chans=3, emded_dim=768):
        super().__init__()
        self.img_size = img_size
        self.patch_size = patch_size
        self.n_patches = (img_size // patch_size) ** 2 # square because it comes from width and height

        self.proj = nn.Conv2d(
            in_channels=in_chans, 
            out_channels=emded_dim,
